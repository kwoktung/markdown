/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd27bcabd75b049fde7b40d37f60b71d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_AUTH_BASE_URL">> {}
}
